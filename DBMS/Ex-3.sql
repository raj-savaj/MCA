...
CREATE TABLE TEXTBOOK(book_isbn VARCHAR(50) primary key,book_title VARCHAR(255),publisher VARCHAR(255),author VARCHAR(255))
CREATE TABLE BOOK_ADOPTION(course_no int  references COURSE(course_no),sem number(3),book_isbn VARCHAR(50) references TEXTBOOK(book_isbn));
